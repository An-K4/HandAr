...
class LanguageFragment : Fragment() {
    ...
    /**
     * Tự vẽ viền + tick ngay lập tức trước khi gọi setApplicationLocales() — không chờ Activity
     * recreate xong mới cập nhật UI (dù độ trễ đó thường rất nhỏ), đúng yêu cầu "chọn là đổi
     * ngôn ngữ + vẽ viền luôn".
     */
